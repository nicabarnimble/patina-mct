...
- Hello/call authority state is per connection. A peer's accepted hello evaluation is carried only inside that connection task and cannot be evicted by another peer.
